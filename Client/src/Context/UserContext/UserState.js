...
export default function UserState(props) {
    ...
    return (
        <UserContext.Provider value={{ mode, setMode, createUser, loginUser, mainUser, getMainUser, user, getUser, friend, getFriend, updateUserCoverPicture, updateUserProfilePicture }} >
            {props.children}
